...
def extract_feature_from_samples(
    generator, inception, truncation, truncation_correlated_latent, batch_size, n_sample, device
):
    ...
    for batch in tqdm(batch_sizes):
        ...
        latent = torch.randn(batch, args.latent, device=device)
        #print('random latent vector generated!')
        img, _ = g(latent, truncation=truncation, truncation_correlated_latent=truncation_correlated_latent)
